...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('logistics_warehouseitem', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 7, 6, 58, 24, 459343))),
        ...
        db.create_table('logistics_customerpackage', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 7, 6, 58, 24, 460194))),
    ...
    models = {
        ...
        'logistics.customerpackage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 6, 58, 24, 460194)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'logistics.warehouseitem': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 6, 58, 24, 459343)'}),

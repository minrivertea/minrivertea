...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPackage.is_preorder'
        db.add_column('logistics_customerpackage', 'is_preorder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'WarehouseItem.is_preorder'
        db.delete_column('logistics_warehouseitem', 'is_preorder')


    def backwards(self, orm):
        # Deleting field 'CustomerPackage.is_preorder'
        db.delete_column('logistics_customerpackage', 'is_preorder')

        # Adding field 'WarehouseItem.is_preorder'
        db.add_column('logistics_warehouseitem', 'is_preorder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        'logistics.customerpackage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

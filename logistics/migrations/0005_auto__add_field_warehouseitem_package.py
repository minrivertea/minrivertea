...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WarehouseItem.package'
        db.add_column('logistics_warehouseitem', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistics.CustomerPackage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WarehouseItem.package'
        db.delete_column('logistics_warehouseitem', 'package_id')
    ...
    models = {
        ...
        'logistics.customerpackage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

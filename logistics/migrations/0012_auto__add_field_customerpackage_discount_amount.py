...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPackage.discount_amount'
        db.add_column('logistics_customerpackage', 'discount_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerPackage.discount_amount'
        db.delete_column('logistics_customerpackage', 'discount_amount')

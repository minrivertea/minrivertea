...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WarehouseItem.reason'
        db.add_column('logistics_warehouseitem', 'reason', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WarehouseItem.reason'
        db.delete_column('logistics_warehouseitem', 'reason')
    ...
    models = {
        ...
        'logistics.customerpackage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 6, 58, 59, 168334)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'logistics.warehouseitem': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 6, 58, 59, 167379)'}),

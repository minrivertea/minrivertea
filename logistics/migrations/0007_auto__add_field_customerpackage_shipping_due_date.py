...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPackage.shipping_due_date'
        db.add_column('logistics_customerpackage', 'shipping_due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerPackage.shipping_due_date'
        db.delete_column('logistics_customerpackage', 'shipping_due_date')
    ...
    models = {
        ...
        'logistics.customerpackage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

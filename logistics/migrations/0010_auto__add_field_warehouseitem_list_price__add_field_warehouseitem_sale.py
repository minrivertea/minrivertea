...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WarehouseItem.list_price'
        db.add_column('logistics_warehouseitem', 'list_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WarehouseItem.sale_price'
        db.add_column('logistics_warehouseitem', 'sale_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WarehouseItem.sale_currency'
        db.add_column('logistics_warehouseitem', 'sale_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Currency'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WarehouseItem.list_price'
        db.delete_column('logistics_warehouseitem', 'list_price')

        # Deleting field 'WarehouseItem.sale_price'
        db.delete_column('logistics_warehouseitem', 'sale_price')

        # Deleting field 'WarehouseItem.sale_currency'
        db.delete_column('logistics_warehouseitem', 'sale_currency_id')

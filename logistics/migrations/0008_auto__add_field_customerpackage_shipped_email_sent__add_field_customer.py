...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPackage.shipped_email_sent'
        db.add_column('logistics_customerpackage', 'shipped_email_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomerPackage.brewing_tips_email_sent'
        db.add_column('logistics_customerpackage', 'brewing_tips_email_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomerPackage.review_email_sent'
        db.add_column('logistics_customerpackage', 'review_email_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomerPackage.reorder_email_sent'
        db.add_column('logistics_customerpackage', 'reorder_email_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerPackage.shipped_email_sent'
        db.delete_column('logistics_customerpackage', 'shipped_email_sent')

        # Deleting field 'CustomerPackage.brewing_tips_email_sent'
        db.delete_column('logistics_customerpackage', 'brewing_tips_email_sent')

        # Deleting field 'CustomerPackage.review_email_sent'
        db.delete_column('logistics_customerpackage', 'review_email_sent')

        # Deleting field 'CustomerPackage.reorder_email_sent'
        db.delete_column('logistics_customerpackage', 'reorder_email_sent')
    ...
    models = {
        ...
        'logistics.customerpackage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

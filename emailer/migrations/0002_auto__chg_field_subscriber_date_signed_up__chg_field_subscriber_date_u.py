...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscriber.date_signed_up'
        db.alter_column('emailer_subscriber', 'date_signed_up', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Subscriber.date_unsubscribed'
        db.alter_column('emailer_subscriber', 'date_unsubscribed', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Subscriber.date_signed_up'
        db.alter_column('emailer_subscriber', 'date_signed_up', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Subscriber.date_unsubscribed'
        db.alter_column('emailer_subscriber', 'date_unsubscribed', self.gf('django.db.models.fields.DateTimeField')(null=True))

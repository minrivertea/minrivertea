...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscriber.hashkey'
        db.add_column('emailer_subscriber', 'hashkey', self.gf('django.db.models.fields.CharField')(default='abc', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscriber.hashkey'
        db.delete_column('emailer_subscriber', 'hashkey')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.subject_line'
        db.add_column('emailer_newsletter', 'subject_line',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=256),
                      keep_default=False)


        # Changing field 'Subscriber.hashkey'
        db.alter_column('emailer_subscriber', 'hashkey', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Newsletter.subject_line'
        db.delete_column('emailer_newsletter', 'subject_line')


        # Changing field 'Subscriber.hashkey'
        db.alter_column('emailer_subscriber', 'hashkey', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

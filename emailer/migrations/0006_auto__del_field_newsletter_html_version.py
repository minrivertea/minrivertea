...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Newsletter.html_version'
        db.delete_column('emailer_newsletter', 'html_version')


    def backwards(self, orm):
        # Adding field 'Newsletter.html_version'
        db.add_column('emailer_newsletter', 'html_version',

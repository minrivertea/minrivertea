...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.external_review_url'
        db.add_column('shop_product', 'external_review_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.external_review_url'
        db.delete_column('shop_product', 'external_review_url')

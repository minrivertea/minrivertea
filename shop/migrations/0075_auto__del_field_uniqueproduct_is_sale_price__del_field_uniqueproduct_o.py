...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UniqueProduct.is_sale_price'
        db.delete_column('shop_uniqueproduct', 'is_sale_price')

        # Deleting field 'UniqueProduct.old_price'
        db.delete_column('shop_uniqueproduct', 'old_price')

        # Adding field 'UniqueProduct.sale_price'
        db.add_column('shop_uniqueproduct', 'sale_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UniqueProduct.is_sale_price'
        db.add_column('shop_uniqueproduct', 'is_sale_price',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UniqueProduct.old_price'
        db.add_column('shop_uniqueproduct', 'old_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'UniqueProduct.sale_price'
        db.delete_column('shop_uniqueproduct', 'sale_price')

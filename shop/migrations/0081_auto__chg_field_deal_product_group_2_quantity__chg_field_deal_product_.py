...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.product_group_2_quantity'
        db.alter_column('shop_deal', 'product_group_2_quantity', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Deal.product_group_3_quantity'
        db.alter_column('shop_deal', 'product_group_3_quantity', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Deal.discount_percent'
        db.alter_column('shop_deal', 'discount_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2))

        # Changing field 'Deal.discount_amount'
        db.alter_column('shop_deal', 'discount_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Deal.product_group_2_quantity'
        raise RuntimeError("Cannot reverse this migration. 'Deal.product_group_2_quantity' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Deal.product_group_3_quantity'
        raise RuntimeError("Cannot reverse this migration. 'Deal.product_group_3_quantity' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Deal.discount_percent'
        raise RuntimeError("Cannot reverse this migration. 'Deal.discount_percent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Deal.discount_amount'
        raise RuntimeError("Cannot reverse this migration. 'Deal.discount_amount' and its values cannot be restored.")
    ...
    models = {
        ...
        'shop.deal': {
            ...
            'discount_percent': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'product_group_2_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'product_group_3_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'shop.discount': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.name'
        db.add_column('shop_deal', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length='200', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.name'
        db.delete_column('shop_deal', 'name')
    ...
    models = {
        ...
        'shop.deal': {
            ...
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['shop.UniqueProduct']", 'null': 'True', 'blank': 'True'}),

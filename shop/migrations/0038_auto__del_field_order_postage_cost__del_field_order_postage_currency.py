...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Order.postage_cost'
        db.delete_column('shop_order', 'postage_cost')

        # Deleting field 'Order.postage_currency'
        db.delete_column('shop_order', 'postage_currency_id')


    def backwards(self, orm):
        
        # Adding field 'Order.postage_cost'
        db.add_column('shop_order', 'postage_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Order.postage_currency'
        db.add_column('shop_order', 'postage_currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Currency'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 12, 28, 33, 63703)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

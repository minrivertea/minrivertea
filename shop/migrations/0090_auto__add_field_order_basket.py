...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_order', 'basket',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Basket'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.basket'
        db.delete_column('shop_order', 'basket_id')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'basket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Basket']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NotifyOutOfStock'
        db.create_table('shop_notifyoutofstock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'])),
        ))
        db.send_create_signal('shop', ['NotifyOutOfStock'])


    def backwards(self, orm):
        # Deleting model 'NotifyOutOfStock'
        db.delete_table('shop_notifyoutofstock')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('shop_emailinstance')
    ...
    def backwards(self, orm):
        ...
        db.create_table('shop_referee', (
            ...
            ('referred_by', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.create_table('shop_emailinstance', (
        ...
        db.send_create_signal('shop', ['EmailInstance'])
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

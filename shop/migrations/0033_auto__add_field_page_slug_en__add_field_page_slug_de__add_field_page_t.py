...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_page', 'slug_en', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Page.slug_de'
        db.add_column('shop_page', 'slug_de', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Page.title_en'
        db.add_column('shop_page', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Page.title_de'
        db.add_column('shop_page', 'title_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Page.meta_title_en'
        db.add_column('shop_page', 'meta_title_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Page.meta_title_de'
        db.add_column('shop_page', 'meta_title_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Page.meta_description_en'
        db.add_column('shop_page', 'meta_description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Page.meta_description_de'
        db.add_column('shop_page', 'meta_description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Page.content_en'
        db.add_column('shop_page', 'content_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Page.content_de'
        db.add_column('shop_page', 'content_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.slug_en'
        db.delete_column('shop_page', 'slug_en')

        # Deleting field 'Page.slug_de'
        db.delete_column('shop_page', 'slug_de')

        # Deleting field 'Page.title_en'
        db.delete_column('shop_page', 'title_en')

        # Deleting field 'Page.title_de'
        db.delete_column('shop_page', 'title_de')

        # Deleting field 'Page.meta_title_en'
        db.delete_column('shop_page', 'meta_title_en')

        # Deleting field 'Page.meta_title_de'
        db.delete_column('shop_page', 'meta_title_de')

        # Deleting field 'Page.meta_description_en'
        db.delete_column('shop_page', 'meta_description_en')

        # Deleting field 'Page.meta_description_de'
        db.delete_column('shop_page', 'meta_description_de')

        # Deleting field 'Page.content_en'
        db.delete_column('shop_page', 'content_en')

        # Deleting field 'Page.content_de'
        db.delete_column('shop_page', 'content_de')
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 3, 1, 39, 27, 669174)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

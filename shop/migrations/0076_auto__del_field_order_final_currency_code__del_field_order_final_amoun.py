...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.final_currency_code'
        db.delete_column('shop_order', 'final_currency_code')

        # Deleting field 'Order.final_amount_paid'
        db.delete_column('shop_order', 'final_amount_paid')

        # Deleting field 'Order.is_confirmed_by_user'
        db.delete_column('shop_order', 'is_confirmed_by_user')

        # Deleting field 'Order.final_discount_amount'
        db.delete_column('shop_order', 'final_discount_amount')

        # Deleting field 'Order.final_items_list'
        db.delete_column('shop_order', 'final_items_list')


    def backwards(self, orm):
        # Adding field 'Order.final_currency_code'
        db.add_column('shop_order', 'final_currency_code',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.final_amount_paid'
        db.add_column('shop_order', 'final_amount_paid',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.is_confirmed_by_user'
        db.add_column('shop_order', 'is_confirmed_by_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.final_discount_amount'
        db.add_column('shop_order', 'final_discount_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Order.final_items_list'
        db.add_column('shop_order', 'final_items_list',
    ...
    models = {
        ...
        'shop.deal': {
            ...
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['shop.UniqueProduct']", 'null': 'True', 'db_index': 'True', 'blank': 'True'}),

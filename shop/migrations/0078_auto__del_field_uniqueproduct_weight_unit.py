...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UniqueProduct.weight_unit'
        db.delete_column('shop_uniqueproduct', 'weight_unit')


    def backwards(self, orm):
        # Adding field 'UniqueProduct.weight_unit'
        db.add_column('shop_uniqueproduct', 'weight_unit',

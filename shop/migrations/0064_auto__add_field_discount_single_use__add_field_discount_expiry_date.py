...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discount.single_use'
        db.add_column('shop_discount', 'single_use',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Discount.expiry_date'
        db.add_column('shop_discount', 'expiry_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discount.single_use'
        db.delete_column('shop_discount', 'single_use')

        # Deleting field 'Discount.expiry_date'
        db.delete_column('shop_discount', 'expiry_date')

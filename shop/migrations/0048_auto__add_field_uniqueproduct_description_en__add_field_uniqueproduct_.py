...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UniqueProduct.description_en'
        db.add_column('shop_uniqueproduct', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UniqueProduct.description_de'
        db.add_column('shop_uniqueproduct', 'description_de',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UniqueProduct.description_en'
        db.delete_column('shop_uniqueproduct', 'description_en')

        # Deleting field 'UniqueProduct.description_de'
        db.delete_column('shop_uniqueproduct', 'description_de')
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 19, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

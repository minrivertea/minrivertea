...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.is_navigation_item'
        db.add_column('shop_category', 'is_navigation_item',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.is_navigation_item'
        db.delete_column('shop_category', 'is_navigation_item')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UniqueProduct.amazon_stock'
        db.add_column('shop_uniqueproduct', 'amazon_stock', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'UniqueProduct.stock'
        db.add_column('shop_uniqueproduct', 'stock', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UniqueProduct.amazon_stock'
        db.delete_column('shop_uniqueproduct', 'amazon_stock')

        # Deleting field 'UniqueProduct.stock'
        db.delete_column('shop_uniqueproduct', 'stock')
    ...
    models = {
        ...
        'shop.uniqueproduct': {
            ...
            'amazon_stock': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 12, 51, 32, 99644)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page.feature_image'
        db.delete_column('shop_page', 'feature_image')

        # Deleting field 'Page.right_side_boxes'
        db.delete_column('shop_page', 'right_side_boxes')

        # Deleting field 'Page.promo_image'
        db.delete_column('shop_page', 'promo_image')

        # Adding field 'Page.is_top_nav'
        db.add_column('shop_page', 'is_top_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Page.list_order'
        db.add_column('shop_page', 'list_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Page.feature_image'
        db.add_column('shop_page', 'feature_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.right_side_boxes'
        db.add_column('shop_page', 'right_side_boxes',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.promo_image'
        db.add_column('shop_page', 'promo_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Page.is_top_nav'
        db.delete_column('shop_page', 'is_top_nav')

        # Deleting field 'Page.list_order'
        db.delete_column('shop_page', 'list_order')

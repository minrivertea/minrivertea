...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UniqueProduct.repeat_item'
        db.add_column('shop_uniqueproduct', 'repeat_item',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UniqueProduct.repeat_item'
        db.delete_column('shop_uniqueproduct', 'repeat_item')
    ...
    models = {
        ...
        'shop.uniqueproduct': {
            ...
            'repeat_item': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 30, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

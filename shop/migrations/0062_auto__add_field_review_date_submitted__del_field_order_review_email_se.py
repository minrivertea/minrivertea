...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.date_submitted'
        db.add_column('shop_review', 'date_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Order.review_email_sent'
        db.delete_column('shop_order', 'review_email_sent')


    def backwards(self, orm):
        # Deleting field 'Review.date_submitted'
        db.delete_column('shop_review', 'date_submitted')

        # Adding field 'Order.review_email_sent'
        db.add_column('shop_order', 'review_email_sent',
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 7, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

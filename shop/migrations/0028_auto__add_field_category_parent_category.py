...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_category', 'parent_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Category'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field product_type on 'Product'
        db.delete_table('shop_product_product_type')


    def backwards(self, orm):
        
        # Deleting field 'Category.parent_category'
        db.delete_column('shop_category', 'parent_category_id')

        # Adding M2M table for field product_type on 'Product'
        db.create_table('shop_product_product_type', (
        ...
        db.create_unique('shop_product_product_type', ['product_id', 'category_id'])
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 8, 59, 1, 421095)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

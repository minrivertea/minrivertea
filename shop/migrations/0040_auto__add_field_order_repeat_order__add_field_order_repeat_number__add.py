...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.repeat_order'
        db.add_column('shop_order', 'repeat_order', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Order.repeat_number'
        db.add_column('shop_order', 'repeat_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Order.frequency'
        db.add_column('shop_order', 'frequency', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'BasketItem.monthly_order'
        db.add_column('shop_basketitem', 'monthly_order', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.repeat_order'
        db.delete_column('shop_order', 'repeat_order')

        # Deleting field 'Order.repeat_number'
        db.delete_column('shop_order', 'repeat_number')

        # Deleting field 'Order.frequency'
        db.delete_column('shop_order', 'frequency')

        # Deleting field 'BasketItem.monthly_order'
        db.delete_column('shop_basketitem', 'monthly_order')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'repeat_order': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 11, 43, 32, 396788)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

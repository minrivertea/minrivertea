...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BasketItem.weight'
        db.delete_column('shop_basketitem', 'weight')

        # Adding field 'BasketItem.weight_multiple'
        db.add_column('shop_basketitem', 'weight_multiple', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BasketItem.weight'
        db.add_column('shop_basketitem', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'BasketItem.weight_multiple'
        db.delete_column('shop_basketitem', 'weight_multiple')
    ...
    models = {
        ...
        'shop.basketitem': {
            ...
            'weight_multiple': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'shop.category': {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 12, 42, 48, 165961)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

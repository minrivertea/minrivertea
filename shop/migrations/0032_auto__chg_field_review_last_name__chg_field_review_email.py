...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.last_name'
        db.alter_column('shop_review', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Review.email'
        db.alter_column('shop_review', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))


    def backwards(self, orm):
        
        # Changing field 'Review.last_name'
        db.alter_column('shop_review', 'last_name', self.gf('django.db.models.fields.CharField')(default='yes', max_length=200))

        # Changing field 'Review.email'
        db.alter_column('shop_review', 'email', self.gf('django.db.models.fields.EmailField')(default='chris@email.com', max_length=75))
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 12, 11, 6, 53, 435314)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

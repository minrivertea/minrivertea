...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Currency.postage_discount_threshold'
        db.add_column('shop_currency', 'postage_discount_threshold', self.gf('django.db.models.fields.IntegerField')(default='1'), keep_default=False)

        # Adding field 'Currency.postage_cost'
        db.add_column('shop_currency', 'postage_cost', self.gf('django.db.models.fields.IntegerField')(default='1'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Currency.postage_discount_threshold'
        db.delete_column('shop_currency', 'postage_discount_threshold')

        # Deleting field 'Currency.postage_cost'
        db.delete_column('shop_currency', 'postage_cost')
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 7, 9, 59, 492231)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UniqueProduct.description_it'
        db.delete_column('shop_uniqueproduct', 'description_it')

        # Deleting field 'Page.meta_description_it'
        db.delete_column('shop_page', 'meta_description_it')

        # Deleting field 'Page.slug_it'
        db.delete_column('shop_page', 'slug_it')

        # Deleting field 'Page.meta_title_it'
        db.delete_column('shop_page', 'meta_title_it')

        # Deleting field 'Page.content_it'
        db.delete_column('shop_page', 'content_it')

        # Deleting field 'Page.title_it'
        db.delete_column('shop_page', 'title_it')

        # Deleting field 'Category.name_it'
        db.delete_column('shop_category', 'name_it')

        # Deleting field 'Category.meta_description_it'
        db.delete_column('shop_category', 'meta_description_it')

        # Deleting field 'Category.long_title_it'
        db.delete_column('shop_category', 'long_title_it')

        # Deleting field 'Category.slug_it'
        db.delete_column('shop_category', 'slug_it')

        # Deleting field 'Category.short_description_it'
        db.delete_column('shop_category', 'short_description_it')

        # Deleting field 'Product.meta_description_it'
        db.delete_column('shop_product', 'meta_description_it')

        # Deleting field 'Product.farm_image'
        db.delete_column('shop_product', 'farm_image')

        # Deleting field 'Product.farm_caption_de'
        db.delete_column('shop_product', 'farm_caption_de')

        # Deleting field 'Product.description_it'
        db.delete_column('shop_product', 'description_it')

        # Deleting field 'Product.tag_text_it'
        db.delete_column('shop_product', 'tag_text_it')

        # Deleting field 'Product.map_caption_en'
        db.delete_column('shop_product', 'map_caption_en')

        # Deleting field 'Product.body_text_it'
        db.delete_column('shop_product', 'body_text_it')

        # Deleting field 'Product.name_it'
        db.delete_column('shop_product', 'name_it')

        # Deleting field 'Product.long_name_it'
        db.delete_column('shop_product', 'long_name_it')

        # Deleting field 'Product.super_short_description_it'
        db.delete_column('shop_product', 'super_short_description_it')

        # Deleting field 'Product.map_caption_de'
        db.delete_column('shop_product', 'map_caption_de')

        # Deleting field 'Product.slug_it'
        db.delete_column('shop_product', 'slug_it')

        # Deleting field 'Product.meta_title_it'
        db.delete_column('shop_product', 'meta_title_it')

        # Deleting field 'Product.map_image'
        db.delete_column('shop_product', 'map_image')

        # Deleting field 'Product.farm_caption_en'
        db.delete_column('shop_product', 'farm_caption_en')

        # Deleting field 'Product.map_caption_it'
        db.delete_column('shop_product', 'map_caption_it')

        # Deleting field 'Product.farm_caption_it'
        db.delete_column('shop_product', 'farm_caption_it')

        # Deleting field 'Product.long_description_it'
        db.delete_column('shop_product', 'long_description_it')

        # Deleting field 'Product.farm_caption'
        db.delete_column('shop_product', 'farm_caption')

        # Deleting field 'Product.map_caption'
        db.delete_column('shop_product', 'map_caption')

        # Adding field 'Product.totm'
        db.add_column('shop_product', 'totm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UniqueProduct.description_it'
        db.add_column('shop_uniqueproduct', 'description_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.meta_description_it'
        db.add_column('shop_page', 'meta_description_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.slug_it'
        db.add_column('shop_page', 'slug_it',
                      self.gf('django.db.models.fields.SlugField')(blank=True, max_length=100, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Page.meta_title_it'
        db.add_column('shop_page', 'meta_title_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.content_it'
        db.add_column('shop_page', 'content_it',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.title_it'
        db.add_column('shop_page', 'title_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_it'
        db.add_column('shop_category', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.meta_description_it'
        db.add_column('shop_category', 'meta_description_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.long_title_it'
        db.add_column('shop_category', 'long_title_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_it'
        db.add_column('shop_category', 'slug_it',
                      self.gf('django.db.models.fields.SlugField')(blank=True, max_length=80, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Category.short_description_it'
        db.add_column('shop_category', 'short_description_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.meta_description_it'
        db.add_column('shop_product', 'meta_description_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.farm_image'
        db.add_column('shop_product', 'farm_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.farm_caption_de'
        db.add_column('shop_product', 'farm_caption_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.description_it'
        db.add_column('shop_product', 'description_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.tag_text_it'
        db.add_column('shop_product', 'tag_text_it',
                      self.gf('django.db.models.fields.CharField')(max_length='100', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.map_caption_en'
        db.add_column('shop_product', 'map_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.body_text_it'
        db.add_column('shop_product', 'body_text_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.name_it'
        db.add_column('shop_product', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.long_name_it'
        db.add_column('shop_product', 'long_name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.super_short_description_it'
        db.add_column('shop_product', 'super_short_description_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.map_caption_de'
        db.add_column('shop_product', 'map_caption_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.slug_it'
        db.add_column('shop_product', 'slug_it',
                      self.gf('django.db.models.fields.SlugField')(blank=True, max_length=80, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Product.meta_title_it'
        db.add_column('shop_product', 'meta_title_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.map_image'
        db.add_column('shop_product', 'map_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.farm_caption_en'
        db.add_column('shop_product', 'farm_caption_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.map_caption_it'
        db.add_column('shop_product', 'map_caption_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.farm_caption_it'
        db.add_column('shop_product', 'farm_caption_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.long_description_it'
        db.add_column('shop_product', 'long_description_it',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.farm_caption'
        db.add_column('shop_product', 'farm_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.map_caption'
        db.add_column('shop_product', 'map_caption',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.totm'
        db.delete_column('shop_product', 'totm')
    ...
    models = {
        ...
        'shop.product': {
            ...
            'totm': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'shop.review': {

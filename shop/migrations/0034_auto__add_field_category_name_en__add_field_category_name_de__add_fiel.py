...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_category', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Category.name_de'
        db.add_column('shop_category', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Category.long_title_en'
        db.add_column('shop_category', 'long_title_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Category.long_title_de'
        db.add_column('shop_category', 'long_title_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Category.meta_description_en'
        db.add_column('shop_category', 'meta_description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Category.meta_description_de'
        db.add_column('shop_category', 'meta_description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Category.short_description_en'
        db.add_column('shop_category', 'short_description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Category.short_description_de'
        db.add_column('shop_category', 'short_description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.name_en'
        db.add_column('shop_product', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.name_de'
        db.add_column('shop_product', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.long_name_en'
        db.add_column('shop_product', 'long_name_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.long_name_de'
        db.add_column('shop_product', 'long_name_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.slug_en'
        db.add_column('shop_product', 'slug_en', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=80, null=True, blank=True), keep_default=False)

        # Adding field 'Product.slug_de'
        db.add_column('shop_product', 'slug_de', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=80, null=True, blank=True), keep_default=False)

        # Adding field 'Product.meta_title_en'
        db.add_column('shop_product', 'meta_title_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.meta_title_de'
        db.add_column('shop_product', 'meta_title_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.meta_description_en'
        db.add_column('shop_product', 'meta_description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.meta_description_de'
        db.add_column('shop_product', 'meta_description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.super_short_description_en'
        db.add_column('shop_product', 'super_short_description_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.super_short_description_de'
        db.add_column('shop_product', 'super_short_description_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.body_text_en'
        db.add_column('shop_product', 'body_text_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.body_text_de'
        db.add_column('shop_product', 'body_text_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.long_description_en'
        db.add_column('shop_product', 'long_description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.long_description_de'
        db.add_column('shop_product', 'long_description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.extra_info_en'
        db.add_column('shop_product', 'extra_info_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.extra_info_de'
        db.add_column('shop_product', 'extra_info_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Product.tag_text_en'
        db.add_column('shop_product', 'tag_text_en', self.gf('django.db.models.fields.CharField')(max_length='100', null=True, blank=True), keep_default=False)

        # Adding field 'Product.tag_text_de'
        db.add_column('shop_product', 'tag_text_de', self.gf('django.db.models.fields.CharField')(max_length='100', null=True, blank=True), keep_default=False)

        # Adding field 'Product.map_location_en'
        db.add_column('shop_product', 'map_location_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.map_location_de'
        db.add_column('shop_product', 'map_location_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.name_en'
        db.delete_column('shop_category', 'name_en')

        # Deleting field 'Category.name_de'
        db.delete_column('shop_category', 'name_de')

        # Deleting field 'Category.long_title_en'
        db.delete_column('shop_category', 'long_title_en')

        # Deleting field 'Category.long_title_de'
        db.delete_column('shop_category', 'long_title_de')

        # Deleting field 'Category.meta_description_en'
        db.delete_column('shop_category', 'meta_description_en')

        # Deleting field 'Category.meta_description_de'
        db.delete_column('shop_category', 'meta_description_de')

        # Deleting field 'Category.short_description_en'
        db.delete_column('shop_category', 'short_description_en')

        # Deleting field 'Category.short_description_de'
        db.delete_column('shop_category', 'short_description_de')

        # Deleting field 'Product.name_en'
        db.delete_column('shop_product', 'name_en')

        # Deleting field 'Product.name_de'
        db.delete_column('shop_product', 'name_de')

        # Deleting field 'Product.long_name_en'
        db.delete_column('shop_product', 'long_name_en')

        # Deleting field 'Product.long_name_de'
        db.delete_column('shop_product', 'long_name_de')

        # Deleting field 'Product.slug_en'
        db.delete_column('shop_product', 'slug_en')

        # Deleting field 'Product.slug_de'
        db.delete_column('shop_product', 'slug_de')

        # Deleting field 'Product.meta_title_en'
        db.delete_column('shop_product', 'meta_title_en')

        # Deleting field 'Product.meta_title_de'
        db.delete_column('shop_product', 'meta_title_de')

        # Deleting field 'Product.meta_description_en'
        db.delete_column('shop_product', 'meta_description_en')

        # Deleting field 'Product.meta_description_de'
        db.delete_column('shop_product', 'meta_description_de')

        # Deleting field 'Product.super_short_description_en'
        db.delete_column('shop_product', 'super_short_description_en')

        # Deleting field 'Product.super_short_description_de'
        db.delete_column('shop_product', 'super_short_description_de')

        # Deleting field 'Product.body_text_en'
        db.delete_column('shop_product', 'body_text_en')

        # Deleting field 'Product.body_text_de'
        db.delete_column('shop_product', 'body_text_de')

        # Deleting field 'Product.long_description_en'
        db.delete_column('shop_product', 'long_description_en')

        # Deleting field 'Product.long_description_de'
        db.delete_column('shop_product', 'long_description_de')
        ...
        # Deleting field 'Product.tag_text_en'
        db.delete_column('shop_product', 'tag_text_en')

        # Deleting field 'Product.tag_text_de'
        db.delete_column('shop_product', 'tag_text_de')

        # Deleting field 'Product.map_location_en'
        db.delete_column('shop_product', 'map_location_en')

        # Deleting field 'Product.map_location_de'
        db.delete_column('shop_product', 'map_location_de')
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 3, 1, 49, 16, 941039)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_wishlist', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 5, 6, 25, 54, 993198))),
        ...
        db.create_table('shop_wishlist_wishlist_items', (
        ...
        db.create_unique('shop_wishlist_wishlist_items', ['wishlist_id', 'basketitem_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('shop_wishlist_wishlist_items')
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 5, 6, 25, 54, 993198)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.slug_en'
        db.alter_column('shop_page', 'slug_en', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True))

        # Changing field 'Page.slug_de'
        db.alter_column('shop_page', 'slug_de', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True))

        # Changing field 'Page.slug'
        db.alter_column('shop_page', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Page.slug_en'
        db.alter_column('shop_page', 'slug_en', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'Page.slug_de'
        db.alter_column('shop_page', 'slug_de', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'Page.slug'
        db.alter_column('shop_page', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

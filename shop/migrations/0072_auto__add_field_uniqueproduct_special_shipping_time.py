...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UniqueProduct.special_shipping_time'
        db.add_column('shop_uniqueproduct', 'special_shipping_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UniqueProduct.special_shipping_time'
        db.delete_column('shop_uniqueproduct', 'special_shipping_time')

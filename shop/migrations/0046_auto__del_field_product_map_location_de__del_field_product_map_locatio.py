...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.map_location'
        db.delete_column('shop_product', 'map_location')

        # Deleting field 'Product.map_page'
        db.delete_column('shop_product', 'map_page_id')

        # Adding field 'Product.map_caption'
        db.add_column('shop_product', 'map_caption', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.farm_image'
        db.add_column('shop_product', 'farm_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Product.farm_caption'
        db.add_column('shop_product', 'farm_caption', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Product.map_location'
        db.add_column('shop_product', 'map_location', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Product.map_page'
        db.add_column('shop_product', 'map_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Page'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 14, 10, 14, 22, 3886)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

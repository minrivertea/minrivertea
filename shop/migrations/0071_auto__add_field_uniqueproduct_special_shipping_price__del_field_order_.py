...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UniqueProduct.special_shipping_price'
        db.add_column('shop_uniqueproduct', 'special_shipping_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Order.sampler_email_sent'
        db.delete_column('shop_order', 'sampler_email_sent')

        # Deleting field 'Order.sampler_sent'
        db.delete_column('shop_order', 'sampler_sent')

        # Deleting field 'Order.wishlist_payee'
        db.delete_column('shop_order', 'wishlist_payee')


    def backwards(self, orm):
        # Deleting field 'UniqueProduct.special_shipping_price'
        db.delete_column('shop_uniqueproduct', 'special_shipping_price')

        # Adding field 'Order.sampler_email_sent'
        db.add_column('shop_order', 'sampler_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.sampler_sent'
        db.add_column('shop_order', 'sampler_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.wishlist_payee'
        db.add_column('shop_order', 'wishlist_payee',
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

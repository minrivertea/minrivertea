...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BasketItem.related_deal'
        db.add_column('shop_basketitem', 'related_deal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Deal'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BasketItem.related_deal'
        db.delete_column('shop_basketitem', 'related_deal_id')
    ...
    models = {
        ...
        'shop.basketitem': {
            ...
            'related_deal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Deal']", 'null': 'True', 'blank': 'True'})
        },
        'shop.category': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_page', 'slug_it',
                      self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Changing field 'Product.long_description_de'
        db.alter_column('shop_product', 'long_description_de', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Product.long_description'
        db.alter_column('shop_product', 'long_description', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Product.long_description_en'
        db.alter_column('shop_product', 'long_description_en', self.gf('ckeditor.fields.RichTextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.long_description_de'
        db.alter_column('shop_product', 'long_description_de', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Product.long_description'
        db.alter_column('shop_product', 'long_description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Product.long_description_en'
        db.alter_column('shop_product', 'long_description_en', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'shop.product': {
            ...
            'extra_info_it': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

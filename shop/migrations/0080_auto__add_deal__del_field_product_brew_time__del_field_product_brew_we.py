...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_deal', (
            ...
            ('product_group_1_quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('product_group_2_quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('product_group_3_quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('free_shipping', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('discount_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2)),
            ('discount_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('last_one_free', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('expiry_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('shop', ['Deal'])

        # Adding M2M table for field product_group_1 on 'Deal'
        m2m_table_name = db.shorten_name('shop_deal_product_group_1')
        ...
        # Adding M2M table for field product_group_2 on 'Deal'
        m2m_table_name = db.shorten_name('shop_deal_product_group_2')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('deal', models.ForeignKey(orm['shop.deal'], null=False)),
            ('uniqueproduct', models.ForeignKey(orm['shop.uniqueproduct'], null=False))
        ...
        # Adding M2M table for field product_group_3 on 'Deal'
        m2m_table_name = db.shorten_name('shop_deal_product_group_3')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('deal', models.ForeignKey(orm['shop.deal'], null=False)),
            ('uniqueproduct', models.ForeignKey(orm['shop.uniqueproduct'], null=False))
        ...
        # Deleting field 'Product.brew_time'
        db.delete_column('shop_product', 'brew_time')

        # Deleting field 'Product.brew_weight'
        db.delete_column('shop_product', 'brew_weight')

        # Deleting field 'Product.brew_temp'
        db.delete_column('shop_product', 'brew_temp')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field product_group_1 on 'Deal'
        db.delete_table(db.shorten_name('shop_deal_product_group_1'))

        # Removing M2M table for field product_group_2 on 'Deal'
        db.delete_table(db.shorten_name('shop_deal_product_group_2'))

        # Removing M2M table for field product_group_3 on 'Deal'
        db.delete_table(db.shorten_name('shop_deal_product_group_3'))

        # Adding field 'Product.brew_time'
        db.add_column('shop_product', 'brew_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.brew_weight'
        db.add_column('shop_product', 'brew_weight',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.brew_temp'
        db.add_column('shop_product', 'brew_temp',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'shop.deal': {
            ...
            'discount_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'discount_percent': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '2'}),
            ...
            'product_group_1_quantity': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'product_group_2_quantity': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'product_group_3_quantity': ('django.db.models.fields.IntegerField', [], {})
        },
        'shop.discount': {

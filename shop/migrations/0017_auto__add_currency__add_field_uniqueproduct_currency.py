...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('shop', ['Currency'])

        # Adding field 'UniqueProduct.currency'
        db.add_column('shop_uniqueproduct', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['shop.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Currency'
        db.delete_table('shop_currency')

        # Deleting field 'UniqueProduct.currency'
        db.delete_column('shop_uniqueproduct', 'currency_id')
    ...
    models = {
        ...
        'shop.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 6, 53, 32, 946132)'}),
            'hashkey': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Shopper']"}),

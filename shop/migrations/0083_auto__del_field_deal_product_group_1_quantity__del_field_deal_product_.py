...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Deal.product_group_1_quantity'
        db.delete_column('shop_deal', 'product_group_1_quantity')

        # Deleting field 'Deal.product_group_3_quantity'
        db.delete_column('shop_deal', 'product_group_3_quantity')

        # Deleting field 'Deal.product_group_2_quantity'
        db.delete_column('shop_deal', 'product_group_2_quantity')


        # Changing field 'Deal.discount_percent'
        db.alter_column('shop_deal', 'discount_percent', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Deal.product_group_1_quantity'
        raise RuntimeError("Cannot reverse this migration. 'Deal.product_group_1_quantity' and its values cannot be restored.")
        # Adding field 'Deal.product_group_3_quantity'
        db.add_column('shop_deal', 'product_group_3_quantity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.product_group_2_quantity'
        db.add_column('shop_deal', 'product_group_2_quantity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogEntry.is_promoted'
        db.add_column('blog_blogentry', 'is_promoted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogEntry.is_promoted'
        db.delete_column('blog_blogentry', 'is_promoted')
